...
public class MainActivityFlower extends AppCompatActivity {
    private EditText ip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manifold =(CheckBox) findViewById(R.id.checkBox_manifold);
    ...
    private static class GrpcTask extends AsyncTask<Void, Void, String> {
        ...
        private final MainActivityFlower activityReference;

        GrpcTask(GrpcRunnable grpcRunnable, ManagedChannel channel, MainActivityFlower activity) {
        ...
        protected void onPostExecute(String result) {
            MainActivityFlower activity = activityReference;
            if (activity == null) {
                return;
            }
    ...
    private interface GrpcRunnable {
        void run(FlowerServiceBlockingStub blockingStub, FlowerServiceStub asyncStub, MainActivityFlower activity) throws Exception;
    }
    ...
    private static class FlowerServiceRunnable implements GrpcRunnable {
        ...
        @Override
        public void run(FlowerServiceBlockingStub blockingStub, FlowerServiceStub asyncStub, MainActivityFlower activity)
                throws Exception {
            join(asyncStub, activity);
        }

        private void join(FlowerServiceStub asyncStub, MainActivityFlower activity)
        ...
        private void handleMessage(ServerMessage message, MainActivityFlower activity) {
