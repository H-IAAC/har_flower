...
class TFLiteTransferConverter(object):
    ...
    def _generate_train_head_model_custom(self):
        """Converts the head training model.
        ...
        with tf.Graph().as_default(), tfv1.Session() as sess:
            ...
            self.head_model.save(f'model/saved_model_temp_head')
            converter = tf.lite.TFLiteConverter.from_saved_model(f'model/saved_model_temp_head') # path to the SavedModel directory
